<?php
    ...
    */
	...
	$shell_command = 'cd ' . '/sites' . '/corliweb' . '/tmp' . '/tmp_inception_converter' . '/' . $token . ' ; source /sites/corliweb/www/python_venv_convinception/bin/activate ; export PYTHONIOENCODING=UTF-8 ; export LANG=fr_FR.UTF-8 ; env python3 /sites/corliweb/www/web_main/export8_autover.py > reconv_out.log 2> reconv_err.log';
    }
