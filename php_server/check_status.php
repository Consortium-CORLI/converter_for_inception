        ...
        if(!is_dir($dir_path)){
            ...
            if(!is_file($log_path)){
                ...
                if($log_status == '100' || $log_status == 100){
                    ...
                    $zip->addFile('/sites' . '/corliweb' . '/www' . '/web_main' . '/uima_to_tei.py','uima_to_tei_for_txm.py');
                    $zip->addFile('/sites' . '/corliweb' . '/www' . '/web_main' . '/tei_to_uima.py','tei_for_txm_to_uima.py');
